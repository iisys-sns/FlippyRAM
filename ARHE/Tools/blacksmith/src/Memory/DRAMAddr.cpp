...
void DRAMAddr::initialize(volatile char *start_address) {
  // Number of Ranks is now dynamically obtained
...
void DRAMAddr::initialize_configs() {
  struct MemConfiguration dram_cfg = {
      ...
      .BK_SHIFT = 24,
      .BK_MASK = (0b000000000000000000000000111111),
      .ROW_SHIFT = 0,
      .ROW_MASK = (0b000000000000000000011111111111),
      .COL_SHIFT = 11,
      ...
      .DRAM_MTX = {          
          ...
          0b000000010001000000000000000000,
          0b000000000001001011001100000000,
      ...
      .ADDR_MTX = {          
          ...
          0b010011100110000000000000001001,
          0b000000100000000000000000000000,
          0b000000010000000000000000000000,
          0b000000001000000000000000000000,
          0b000000000100000000000000000000,
  ...
  DRAMAddr::Configs = {
       {(CHANS(1UL) | DIMMS(1UL) | RANKS(1UL) | BANKS(64UL)), dram_cfg}
 };
}
